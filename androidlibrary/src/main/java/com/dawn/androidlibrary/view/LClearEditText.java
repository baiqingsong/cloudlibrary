...
import com.dawn.androidlibrary.util.LDensityUtil;
...
public class LClearEditText extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    public LClearEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        @SuppressLint("Recycle") TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.LClearEditText, 0, 0);
    ...
    public LClearEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        @SuppressLint("Recycle") TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.LClearEditText, defStyleAttr, 0);
        int size = array.getDimensionPixelSize(R.styleable.LClearEditText_clearSize, DEFAULT_SIZE);
        init(size);
    }
...
//        mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth(), mClearDrawable.getIntrinsicHeight());
        mClearDrawable.setBounds(0, 0, LDensityUtil.dip2px(getContext(), size), LDensityUtil.dip2px(getContext(), size));
        //默认设置隐藏图标

...
import com.dawn.androidlibrary.util.LImageUtil;
...
public class LBottomNavigationBar extends LinearLayout {
    ...
    public void addItemBar(String iconPath, String title) {
        ...
        @SuppressLint("InflateParams") View item = layoutInflater.inflate(R.layout.l_item_tabbar_layout, null);
        ImageView icon = item.findViewById(R.id.tabbar_imageView);
        LImageUtil.displayImage(super.getContext(), iconPath, icon);
        TextView titleView = item.findViewById(R.id.tabbar_titleView);
    ...
    private class OnItemBarClickListener implements OnClickListener {
        ...
        OnItemBarClickListener(int index) {
            this.index = index;
        }
